...
help:
    @echo "╔══════════════════════════════════════════════════════════════════════════════╗"
    @echo "║                GitHub Linear Metrics Development Commands                   ║"
    @echo "╚══════════════════════════════════════════════════════════════════════════════╝"
    @echo ""
    @echo "🚀 QUICK START:"
    ...
    @echo "  setup                  Initial project setup with UV and dependencies"
    ...
    @echo "  uv-status             Show UV environment status and configuration"
    @echo "  fix-imports           Test and validate Python import resolution"
    @echo "  extract-test <org>    Run test extraction to validate setup"
    @echo "  cleanup-temp          Clean up temporary files and artifacts"
