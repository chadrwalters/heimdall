...
class TestExtractionScriptCaching:
        ...
        for resource_type, keys in cache_keys.items():
            for key in keys:
                ...
                if resource_type == "repos":
                    assert any(pattern in key for pattern in ["degree-analytics", "meta_", "_page_"])
    ...
    def test_cache_error_handling(self):
        ...
        error_scenarios = [
            {
                "scenario": "corrupted_cache_file",
                "expected_behavior": "fallback_to_api"
            },
            {
            ...
            },
            {
                ...
                "expected_behavior": "skip_cache_use_api"
            },
            {
                "scenario": "disk_full",
                "expected_behavior": "skip_cache_write_continue"
            }
        ]
    ...
    def test_cache_data_consistency(self):
        ...
        consistency_tests = [
            {
                "scenario": "same_pr_different_fetches",
                "expected": "identical_data"
            },
            {
                "scenario": "repo_list_pagination",
                "expected": "complete_repo_list"
            },
            {
                "scenario": "commit_history_consistency",
                "expected": "chronological_order"
            }
        ]
    ...
    def test_incremental_cache_updates(self):
        ...
        update_scenarios = [
            {
                "scenario": "new_prs_since_last_run",
                "cache_behavior": "fetch_only_new_prs"
            },
            {
                "scenario": "pr_state_changes",
                "cache_behavior": "update_changed_pr_details"
            },
            {
                "scenario": "new_commits_since_last_run",
                "cache_behavior": "fetch_only_new_commits"
            }
        ]
        ...
        failure_scenarios = [
            {
                ...
                "recovery_strategy": "use_stale_cache_if_available"
            },
            {
