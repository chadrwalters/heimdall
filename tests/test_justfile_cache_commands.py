...
class TestJustfileCacheCommands:
    ...
    def create_sample_cache_files(self):
        ...
        for subdir, filename, data in sample_files:
            cache_entry = {"cached_at": "2025-07-09T19:05:53Z", "ttl_seconds": 3600, "data": data}
    ...
    def test_cache_command_integration(self):
        ...
        integration_tests = [
            {"scenario": "extract_after_cache_clean", "expected_behavior": "fresh_api_calls"},
            {"scenario": "extract_with_valid_cache", "expected_behavior": "use_cached_data"},
            {"scenario": "extract_after_cache_rebuild", "expected_behavior": "populate_new_cache"},
        ]
    ...
    def test_cache_command_safety_checks(self):
        ...
        safety_checks = [
            {"command": "cache-rebuild", "safety_check": "user_confirmation", "required": True},
            {"command": "cache-clean", "safety_check": "backup_important_data", "required": False},
            {"command": "cache-status", "safety_check": "read_only_operation", "required": False},
        ]
...
class TestJustfileCacheIntegration:
    ...
    def test_cache_command_reliability(self):
        ...
        reliability_tests = [
            {"scenario": "large_cache_size", "cache_size_mb": 100, "expected_reliability": "high"},
            {"scenario": "many_cache_files", "file_count": 1000, "expected_reliability": "medium"},
            {
        ...
        for test in reliability_tests:
            ...
            assert test["expected_reliability"] in ["high", "medium", "handles_gracefully"]
